...
from data.config.account.choices import C_GENDER_ACCOUNT, C_STATUS_ACCOUNT, STATUS_ACCOUNT_ACTIVE
...
class Account(models.Model):
    ...
    status = models.IntegerField(choices=C_STATUS_ACCOUNT, default=STATUS_ACCOUNT_ACTIVE, null=True, blank=True)
